...
DcAppDrawPlanetViewHandle dc_app_draw_context_planet_view_peek(DcAppDrawContext *draw_ctx);
void dc_app_draw_context_finish_planet_views(DcAppDrawContext *draw_ctx, int first_view);
bool dc_app_draw_context_planet_container_active(DcAppDrawContext *draw_ctx);
