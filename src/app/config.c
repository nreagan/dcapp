            ...
            if (value2) {
                ...
                if (is_double) {
                    ...
                    switch (cond_type) {
                        ...
                        case DC_APP_CONDITIONAL_TYPE_GTE:
                            ...
                            break;
                        default:
                            fprintf(stderr, "DCAPP _clean_xml_node(): StaticIf: unknown conditional_type %d\n", cond_type);
                            break;
                    }
                } else if (is_bool) {
                    // Boolean comparison
                ...
                switch (cond_type) {
                    ...
                    case DC_APP_CONDITIONAL_TYPE_FALSE:
                        ...
                        break;
                    default:
                        fprintf(stderr, "DCAPP _clean_xml_node(): StaticIf: unknown conditional_type %d for single value\n", cond_type);
                        break;
                }
            }
