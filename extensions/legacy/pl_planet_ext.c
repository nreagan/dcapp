...
pl_create_planet_view(plPlanet* ptPlanet, plCommandBuffer* ptCmdBuffer, plPlanetViewInit tInit)
{
    ...
    if(tInit.pcVertexShader == NULL) tInit.pcVertexShader = "legacy/planet.vert";
    if(tInit.pcFragmentShader == NULL) tInit.pcFragmentShader = "legacy/planet.frag";
...
{
    ptPlanet->pcVertexShader   = pcVertexShader   ? pcVertexShader   : "legacy/planet.vert";
    ptPlanet->pcFragmentShader = pcFragmentShader ? pcFragmentShader : "legacy/planet.frag";
